...
inline Type Fighting  = {"Fighting", FIGHTING, {NORMAL, ROCK, STEEL, ICE, DARK}, {FAIRY, POISON, FLYING, PSYCHIC, BUG}, {GHOST}};
...
inline Type Bug       = {"Bug", BUG, {GRASS, PSYCHIC, DARK}, {FIRE, FIGHTING, POISON, FLYING, STEEL, FAIRY}, {}};
